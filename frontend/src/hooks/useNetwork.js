...
// returns the connected wallet's chain, or the first configured chain (local
// 31337) when no wallet is connected — which is exactly what we want for the
// public/no-wallet reads on the Network page.
